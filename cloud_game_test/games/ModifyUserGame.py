...
#### class ModifyUserGameTestCasedesoverlong(ClougGameTestCaseBase):
    '''ModifyUserGame 描述超长
    '''
    owner = "ppeterzhao"
    timeout = 5
...
###class ModifyUserGameTestCasestateoffline(ClougGameTestCaseBase):
    '''ModifyUserGame stateoffline
    '''
    owner = "ppeterzhao"
    timeout = 5
    priority = TestCase.EnumPriority.High
...
###class ModifyUserGameTestCasegameinstancetype(ClougGameTestCaseBase):
    '''ModifyUserGame instancetype正常
    '''
    owner = "ppeterzhao"
    timeout = 5
    priority = TestCase.EnumPriority.High
...
###class ModifyUserGameTestCasegameinstancetypeun(ClougGameTestCaseBase):
    '''ModifyUserGame instancetype异常
    '''
    owner = "ppeterzhao"
    timeout = 5
    priority = TestCase.EnumPriority.High
