...
class ModifyInstanceBasicAttribute(ClougGameTestCaseBase):
    '''ModifyInstanceBasicAttribute，验证基本属性
    '''
    owner = "ppeterzhao"
    timeout = 5
    ...
    def run_test(self):
        ...
        # ==========
        self.start_step('ModifyInstanceBasicAttribute, GameId={}'.format(game_id))
        ...
        resp = self.api3client.call('ModifyInstanceBasicAttribute', params)
...
class ModifyInstanceBasicAttributeinstancenone(ClougGameTestCaseBase):
    '''ModifyInstanceBasicAttribute，instanceid不存在
    '''
    owner = "ppeterzhao"
    timeout = 5
    priority = TestCase.EnumPriority.High
...
class ModifyInstanceBasicAttributeinstancenull(ClougGameTestCaseBase):
    '''ModifyInstanceBasicAttribute，instanceid为null
    '''
    owner = "ppeterzhao"
    timeout = 5
    priority = TestCase.EnumPriority.High
...
class ModifyInstanceBasicAttributenamevoverlong(ClougGameTestCaseBase):
    '''ModifyInstanceBasicAttribute，name超长
    '''
    owner = "ppeterzhao"
    timeout = 5
    priority = TestCase.EnumPriority.High
...
class ModifyInstanceBasicAttributedesoverlong(ClougGameTestCaseBase):
    '''ModifyInstanceBasicAttribute，description超长
    '''
    owner = "ppeterzhao"
    timeout = 5
    priority = TestCase.EnumPriority.High
...
if __name__ == '__main__':
    ...
    ModifyInstanceBasicAttribute().debug_run()