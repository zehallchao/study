...
###class CreateGroupTestCasedecoverlong(ClougGameTestCaseBase):
    '''CreateGroup, 描述超长
    '''
    owner = "ppeterzhao"
    timeout = 5
    ...
    def run_test(self):
        ...
        params = {
            'Name': group_name,
            'Description': 'hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh'
        }
        resp = self.api3client.call('CreateGroup', params)
...
###class CreateGroupTestCasenameoverlong(ClougGameTestCaseBase):
    '''CreateGroup, name超长
    '''
    owner = "ppeterzhao"
    timeout = 5
...
###class CreateGroupTestCasenamere(ClougGameTestCaseBase):
    '''CreateGroup, name重名
    '''
    owner = "ppeterzhao"
    timeout = 5
...
###class CreateGroupTestCasegroupmax(ClougGameTestCaseBase):
    '''CreateGroup, group达到上限
    '''
    owner = "ppeterzhao"
    timeout = 5
    priority = TestCase.EnumPriority.High
